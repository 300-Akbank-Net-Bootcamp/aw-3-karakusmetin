...
public record GetAccountTransactionByParameterQuery(string ReferenceNumber, decimal Amount, string Description) : IRequest<ApiResponse<List<AccountTransactionResponse>>>;