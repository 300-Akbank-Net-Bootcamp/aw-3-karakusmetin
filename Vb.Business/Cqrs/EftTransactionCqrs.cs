...
public record GetEftTransactionByParameterQuery(string ReferenceNumber, string SenderName, string SenderAccount) : IRequest<ApiResponse<List<EftTransactionResponse>>>;